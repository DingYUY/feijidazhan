...
public class GamePanel extends JPanel {
    ...
    private final int SCREEN_WIDTH = 800;//屏幕宽
    private final int SCREEN_HEIGHT = 600;//屏幕高
    static final int MAP_WIDTH = 600;//地图面板宽
    static final int MAP_HEIGHT = 600;//地图面板高
    static final int BULLET_WIDTH = 15;//子弹宽
    static final int BULLET_HEIGHT = 30;//子弹高
    static final int PLANE_SIZE = 100;//玩家飞机边长
    static final int ENEMY_SIZE = 80;//敌机边长
    static final int BOSS_WIDTH = 250;//boss宽
    static final int BOSS_HEIGHT = 180;//boss高
    ...
    public GamePanel(MainPanel m) {
        ...
        this.m = m;//主面板对象将地址传过来

        live = 100;//生命初始值
        live1 = 2000;//boss生命初始值
    ...
    private class MapPanel extends Canvas implements Runnable {
        ...
        private Collide c;//碰撞判断的对象
        private Image x;//图片对象
        private ArrayList<Bullet[]> arr;//boss子弹数组
        ...
        MapPanel() {
            ...
            array = new ArrayList<Bullet>();//初始化玩家飞机子弹数组
            array1 = new ArrayList<Bullet>();//初始化敌机子弹数组
...
//			}
        ...
        private void draw() {
            ...
            {
                c.bullet_plane(array1.get(i), mp);//玩家飞机和敌机子弹碰撞
            ...
            {
                e_array[i].enemyMove();
                c.plane_enemy(mp, e_array[i]);//敌机与玩家飞机碰撞
            }
