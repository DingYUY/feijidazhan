        ...
        if(m.getX_Y().getX() >= e.getX_Y().getX()-GamePanel.PLANE_SIZE
            ...
            if(GamePanel.live <= 50) {
                ...
                if(PlaySound.b[3]) {
                    ...
                    p = new PlaySound();
//					try {
//						p.open(getClass().getResource("src/sounds/HeroBrustSound.wav").toURI().getPath());
                    p.open("src/sounds/HeroBrustSound.wav");
                    p.play();
                    p.start();
